...
public class ActivityTest {
    ...
    private Entry firstEntry = new Entry(true, startDateTime, 60, firstPosition);
    ...
    private Entry thirdEntry = new Entry(false, thirdDateTime, 80, thirdPosition);
    ...
    private Entry fourthEntry = new Entry(false, fourthDateTime, 90, fourthPosition);
    ...
    private Entry fifthEntry = new Entry(false, fifthDateTime, 100, fifthPosition);
    ...
    private Entry sixthEntry = new Entry(false, sixthDateTime, 110, sixthPosition);
